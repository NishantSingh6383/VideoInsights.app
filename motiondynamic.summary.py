...
def create_video(key_frames, output_path, fps=30):
    height, width, layers = key_frames[0].shape
...
if __name__ == '__main__':
    ...
    output_path = 'C:/Users/admin/OneDrive/Desktop/VideoSum/motion.summaryvid.mp4'
